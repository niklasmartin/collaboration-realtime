...
(function (root) {
  ...
  function buildV5() {
    ...
    scene.stamp('evidence-author', {
      x: 160, y: 360, text: 'Recherche-Agent - vorgeschlagen', kind: 'agent', opacity: 0,
    });
    scene.stamp('review-state', {
      x: 520, y: 96, text: 'Von Maya geprüft', kind: 'human', opacity: 0,
    });
    scene.button('undo', { x: 626, y: 372, w: 142, h: 34, label: 'Agentenaktion rückgängig', opacity: 0 });
    ...
    scene.showIntent('research', 'FÜGT NACHWEISE HINZU', 1550, {
    ...
    scene.setStampText('evidence-author', 'Recherche-Agent - hinzugefügt', 4700, { kind: 'agent' });
    scene.appendActivity('Recherche-Agent hat Nachweis hinzugefügt', 4700);
    ...
    scene.showIntent('structure', 'VERBINDET IDEEN', 5450, {
    ...
    scene.showIntent('maya', 'PRÜFT FRAGE', 8000, {
    ...
    scene.showIntent('structure', 'IDEE IN LAYOUT-GRUPPE VERSCHIEBEN', 11100, {
    ...
    scene.showIntent(null, 'AGENTENVERSCHIEBUNG BLOCKIERT - AKTIVE MENSCHLICHE BEARBEITUNG GEWINNT', 12700, {
