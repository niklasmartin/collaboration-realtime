...
(function (root) {
  ...
  function buildV2Swimlane() {
    ...
    scene.region('agentLane', { x: LANE.x, y: LANE.y, w: LANE.w, h: LANE.h, label: 'Agentenspur' });
    ...
    scene.appendActivity('Nachweis in Spur vorgeschlagen', 10100);
    ...
    scene.showIntent('agent', 'Pausiert', 11600, { anchor: { x: 630, y: 168 }, duration: 900 });
    ...
    scene.appendActivity('Nachweis in Hauptstrang übernommen', 13800);
