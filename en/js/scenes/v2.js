...
(function (root) {
  ...
  function buildV2() {
    ...
    scene.button('run', { x: 420, y: 168, w: 88, h: 36, label: 'Run' });
    ...
    scene.button('research', { x: 540, y: 168, w: 96, h: 36, label: 'Research', opacity: 0 });
    ...
    // acts again.
    scene.appendActivity('User acts', 1400);
    scene.appendActivity('System responds', 2600);
    scene.appendActivity('User acts again', 2900);
    ...
    scene.appendActivity('Research requested', PHASE2 + 1000);
    ...
    scene.showCursor('agent', PHASE2 + 1200, { fade: 200, label: 'Research agent' });
    ...
    scene.showIntent('agent', 'Reading', PHASE2 + 2000, {
      anchor: { x: 220, y: 154 },
      duration: 900,
    });
    ...
    scene.showIntent('agent', 'Adding evidence', PHASE2 + 3900, {
      anchor: { x: 480, y: 264 },
      duration: 1000,
    });
    ...
    scene.appendActivity('Evidence proposed', PHASE2 + 5300);
    ...
    // implicit.
    scene.showIntent('agent', 'Paused', PHASE2 + 6400, {
      anchor: { x: 620, y: 278 },
      duration: 900,
    });
    ...
    scene.appendActivity('Evidence committed', PHASE2 + 7900);
