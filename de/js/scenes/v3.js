...
(function (root) {
  ...
  function buildV3() {
    ...
    scene.cursor('researchAgent',   { kind: 'agent', x: 410, y: 56,  label: 'Recherche-Agent', opacity: 1 });
    ...
    scene.showCursor('you', 700, { fade: 160, label: 'Sie' });
    ...
    scene.showCursor('structureAgent', 4800, { fade: 160, label: 'Struktur-Agent' });
    ...
    scene.createNode('yourTarget', 7500, {
      x: 20, y: 355, w: 190, h: 42, label: 'Ihr Ziel: links', kind: 'ghost', duration: 300,
    });
    scene.createNode('agentTarget', 7500, {
      x: 590, y: 355, w: 190, h: 42, label: 'Agentenziel: rechts', kind: 'ghost', duration: 300,
    });
